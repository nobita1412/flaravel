          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{ url('/admin/shop/product/order') }}"><i class="fa fa-angle-right"></i> Đặt hàng</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{ url('/admin/config') }}"><i class="fa fa-angle-right"></i> Globl Settings</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{ url('/admin/new') }}"><i class="fa fa-angle-right"></i> Newletters</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{ url('/admin/banner') }}"><i class="fa fa-angle-right"></i> Banners</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
